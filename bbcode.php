  ...
  class BBCode {    
    public function toHTML ($str) {
      ...
      $bbcode_conversion_table = array(
        ...
        "/\[youtube\](?:http?:\/\/)?(?:www\.)?youtu(?:\.be\/|be\.com\/watch\?v=)([A-Z0-9\-_]+)(?:&(.*?))?\[\/youtube\]/i" => function ($match) {
      ...
      foreach($bbcode_conversion_table as $key => $val) {
